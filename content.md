...
-Navigation + LOGO
-hero (100vh)
-Features in (features in section is just after the hero section ,sometimes it is inside the hero section )
-how it works
-Meals + list of diets
-Testimonials + Gallery
-features + Pricingl
-CTA (Call to action section ,it is most of the time at the end of the section just before the footer)
-Footer
